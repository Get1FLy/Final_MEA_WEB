...
const SuperAdminNavBar = ({ handleLogout, user_id }) => {
        ...
        <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                <li><Link className="dropdown-item" to="/notices">View Notices</Link></li>
                <li><Link className="dropdown-item" to='/add_circular'>Add Notices</Link></li>
              </ul>
            </li>
            <li><Link to="/notices" className="nav-link px-2 link-body-emphasis position-relative">Notices</Link>
            {/* <Link to='/notices'>
              <li class="nav-link px-2 link-body-emphasis position-relative">
                Notices
            ...
            <li><Link to="/add_admin" className="nav-link px-2 link-body-emphasis">Add Admin</Link></li>
            ...
            {/* <li>
              ...
              <div className={!isAnimating ? "alert_icons" : "alert_icons stopped"}>
          <MdOutlineNotificationsActive style={{ width: '25px', height: '25px',marginTop:"5px" }} />
        </div>
              </Link>
            </li> */}
          </ul>
