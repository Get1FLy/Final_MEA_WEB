...
const AdminLogin = ({handleLogin,token}) => {
 ...
 const navigate=useNavigate()
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const apiEndpoint ='http://localhost:4000/admin_login';
        ...
        <>
            ...
            <div className="login-box">
                ...
                {showLogin ? (
                    ...
                    <h2 className="mb-3" style={{ fontSize: '30px',color:'navy' }}>Welcome Admin</h2>
                    <p style={{ color: 'grey', fontSize: '15px',padding:'0px' }}>( Login with your ID and Password )</p>
                        ...
                        <button className="btn btn-primary w-100 mt-2" type="submit" value="Login" style={{backgroundColor:'#0c0c54'}} onClick={handleSubmit}>Login</button>
